...
/*
  ...
  * @param Sample rate
*/
void HPFilter::setSampleRate(int rate)
{
	sampleRate_ = rate;	
...
*/
void HPFilter::setFrequency(float frequency)
{
...
/*
  ...
  * @param Cutoff frequency
*/
float HPFilter::getFilteredSample(float in,float frequency)
{
...
/*
  ...
  * @param Q factor
*/
void HPFilter::calculateCoefficients(float frequency, float Q)
{
